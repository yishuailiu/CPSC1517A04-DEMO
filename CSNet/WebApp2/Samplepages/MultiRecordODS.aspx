...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="ProductList" runat="server"
              ...
              <Columns>
                ...
                <asp:TemplateField HeaderText="Supplier">
                    <ItemTemplate>
                       <%--<asp:Label ID="SupplierID" runat="server" 
                        ...
                        <asp:DropDownList ID="SupplierListGV" runat="server" DataSourceID="SupplierListODS" DataTextField="CompanyName" DataValueField="SupplierID" SelectedValue='<%# Eval("SupplierID") %>' Enabled="false"></asp:DropDownList>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Category">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="CategoryListGV" runat="server" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryID" SelectedValue='<%# Eval("CategoryID") %>' Enabled="false"></asp:DropDownList>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
            ...
            <EmptyDataTemplate>
                No prodcts to display for selected category.
            </EmptyDataTemplate>
        </asp:GridView>
        <br /><br />
    ...
    <asp:ObjectDataSource ID="ProductListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Product_GetByCategory" TypeName="NorthWindSystem.BLL.ProductController">
        <SelectParameters>
